...
describe("Validation des entrées", () => {
  test("evaluateFiveCards devrait rejeter moins de 5 cartes", () => {
    const cards = [
      new Card(Rank.Ace, Suit.Hearts),
      new Card(Rank.King, Suit.Hearts),
      new Card(Rank.Queen, Suit.Hearts),
    ...
    expect(() => evaluateFiveCards(cards)).toThrow(
      "Doit fournir exactement 5 cartes",
    );
  });
  test("evaluateFiveCards devrait rejeter plus de 5 cartes", () => {
    const cards = [
      new Card(Rank.Ace, Suit.Hearts),
      new Card(Rank.King, Suit.Hearts),
      new Card(Rank.Queen, Suit.Hearts),
  ...
  test("findBestFiveCardHand devrait rejeter moins de 5 cartes", () => {
    const cards = [
      new Card(Rank.Ace, Suit.Hearts),
      new Card(Rank.King, Suit.Hearts),
    ];
    expect(() => findBestFiveCardHand(cards)).toThrow(
      "Besoin d'au moins 5 cartes",
    );
  });
});
